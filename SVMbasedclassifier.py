...
if __name__ == '__main__':
    ...
    pipeline_s,title_te_s,label_te_s = clf_train(title1,label1)
    print("training classifier for germline")
    pipeline_g,title_te_g,label_te_g = clf_train(title1,label2)
    print("training done")
    ...
    plot_learning_curve(pipeline_s,title1,label1,ylim=(0.7,1.01),n_jobs=4)
    plt.show()
    print("learning curve germline")
    plot_learning_curve(pipeline_g,title1,label2,ylim=(0.7,1.01),n_jobs=4)
    plt.show()
    ...
    pipeline_p,title_te_p,label_te_p = clf_train(title2,labelf)
    print("training done")
    print("getting metrics for polymorphism")
    metrics(title_te_p,label_te_p,pipeline_p)
    print("learning curve polymorphism")
    plot_learning_curve(pipeline_p,title2,labelf,ylim=(0.7,1.01),n_jobs=4)
    plt.show()
    ...
    pipeline_pe,title_te_pe,label_te_pe = clf_train(title3,label_p)
    print("training classifier for incidence")
    pipeline_i,title_te_i,label_te_i = clf_train(title3,label_i)
    print("training done")
    ...
    plt = plot_learning_curve(pipeline_pe,title3,label_p,ylim=(0.7,1.01),n_jobs=4)
    plt.show()
    print("learning curve incidence")
    plt = plot_learning_curve(pipeline_i,title3,label_i,ylim=(0.7,1.01),n_jobs=4)
    plt.show()
